...
<ClientOnlyNAlert title="如上图所示, Project HugoAura 的各类产品能力范围包括:" type="success">
  <template #icon>
...
<ClientOnlyNAlert title="但是, Project HugoAura:" type="error">
  <template #icon>
...
<ClientOnlyNAlert title="继续操作, 您可能会面临:" type="warning">
  <template #icon>
